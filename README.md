...
2.2. [Installing Manually](#install-manual)
2.3. [Install from Vimball](#install-vimball)
2.4. [Install with Pathogen](#install-pathogen)
2.4.1 [Install Pathogen](#install-pathogen-step1)
2.4.2 [Install Commentable](#install-pathogen-step2)
2.5. [Install with Vundle](#install-vundle)
2.5.1 [Install Vundle](#install-vundle-step1)
2.5.2 [Install Commentable](#install-vundle-step2)
